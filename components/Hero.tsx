  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center h-full">
        <div className="text-center px-4 py-6 my-18">
        ...
        <div className="px-2 mx-2 my-4 w-[800px]">
          <p className="text-lg md:text-2xl text-[#BFC6F5] font-semibold tracking-tight text-center ">
            ...
            to everyday needs, everything is just a click away
          </p>
        </div>

        <div className="flex gap-3 mt-4 p-1 items-center justify-center w-[209px] h-[38px]">
          <div>
            <Button variant="default" className="text-white h-9 ">
              Get Started
            </Button>
          </div>
          <div>
            <Button variant="outline" className="text-white h-9 outline-2">
              learn more
            </Button>
          </div>
        </div>
